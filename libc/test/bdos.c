/* BDOS.C: This example calls DOS function 0x9 (display string) to
 ...
 * This will be true for all memory models if the string is  *declared
 * near.
 */
char near str[] = "Hello world!\r\n$";
